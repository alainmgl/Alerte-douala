...
function mapErrorName(name) {
  if (name === 'NotAllowedError' || name === 'SecurityError') {
    return { status: 'denied', message: i18n.t('reportForm.permissionDefault') };
  }
  if (name === 'NotFoundError' || name === 'OverconstrainedError') {
    return { status: 'unsupported', message: i18n.t('reportForm.permissionDefault') };
  }
  if (name === 'NotReadableError' || name === 'AbortError') {
    return { status: 'error', message: i18n.t('reportForm.permissionDefault') };
  }
  return { status: 'error', message: i18n.t('reportForm.permissionDefault') };
}
