...
export default function AdminPending() {
  ...
  async function handleConfirmValidate() {
    ...
    try {
      ...
      notify({
        tone: 'success',
        title: t('notifications.tagDisasterValidated'),
  ...
  return (
    <DashboardLayout
      navItems={navItems}
      eyebrow={t('admin.pending.eyebrow')}
      title={t('admin.pending.title')}
      tone="admin"
    >
      <section className={styles.intro}>
        <p className={styles.lead}>{t('admin.pending.lead')}</p>
      </section>
      ...
      <Modal
        ...
        title={t('admin.pending.validateTitle')}
        size="sm"
      >
        {confirmValidate && (
          <div className={styles.confirmBody}>
            <p className={styles.confirmText}>{t('admin.pending.validateBody')}</p>
            ...
            <div className={styles.confirmActions}>
              ...
              >
                {t('admin.pending.validateConfirm')}
              </button>
            </div>
          </div>
        )}
